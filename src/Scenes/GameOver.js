class GameOver extends Phaser.Scene {
    ...
    create() {
        ...
        my.sprite.credits = this.add.text(0, 0, "Credits!\nJarod Spangler: Lead Programmer and Game Designer\nJack Wilhelm: Gun Design, Dash Design, Credits, End Screen\nKenny Assests: Sounds, Particles, Assests", { fontFamily: 'font1', fontSize: '20px', fill: '#000000', stroke: '#FFFFFF', strokeThickness: 14 }).setOrigin(.5).setPosition(game.config.width/2-100, game.config.height/2 - 250);
