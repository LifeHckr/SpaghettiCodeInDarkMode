class TitleScreen extends Phaser.Scene {
    ...
    create() {
        ...
        this.sprite.title = this.add.text(0, 0, "Pizza With Gun", { align: "center", fontFamily: 'font1', fontSize: '60px', fill: '#F00000', wordWrap: {width: 800},  stroke: '#d4af37', strokeThickness: 20}).setOrigin(.5).setDepth(5).setScale(1).setPosition(game.config.width/2, 50);
        ...
        this.sprite.warning = this.add.text(0, 0, 'Warning: "Uh Oh" mode will probably lag your browser ALOT.', { align: "center", wordWrap: {width: 800}, fontFamily: 'font1', fontSize: '30px', fill: '#F00000', stroke: '#FFFFFF', strokeThickness: 14 }).setOrigin(.5).setPosition(game.config.width/2, 625).setDepth(1);
        ...
        this.input.on('dragend', (pointer, object) =>{
            if (game.config.physics.arcade.debug) {
                ...
                my.levelConfig = {minLength: 5, maxLength: 7, branches : 7, maxRooms: 20, treasures: 2, openWeight: 1, closedWeight: 0, seed: undefined, width: 4, height: 5};

            } else if (object === this.sprite.medium){
                my.levelConfig = {minLength: 6, maxLength: 10, branches : 7, maxRooms: 35, treasures: 3, openWeight: .75, closedWeight: .1, seed: undefined, width: 8, height: 7};

            } else if (object === this.sprite.hard){
                my.levelConfig = {minLength: 99, maxLength: 99, branches : 9, maxRooms: undefined, treasures: 2, openWeight: .75, closedWeight: 0, seed: undefined, width: 10, height: 10};
