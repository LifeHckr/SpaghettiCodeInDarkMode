class TitleScreen extends Phaser.Scene {
    ...
    create() {
        ...
        this.sprite.warning = this.add.text(0, 0, 'Warning: "Uh Oh" mode is moderately unpredictable and possibly laggy.', { align: "center", wordWrap: {width: 800}, fontFamily: 'font1', fontSize: '30px', fill: '#F00000', stroke: '#FFFFFF', strokeThickness: 14 }).setOrigin(.5).setPosition(game.config.width/2, 625).setDepth(1);
        ...
        this.input.on('dragend', (pointer, object) =>{
            if (game.config.physics.arcade.debug) {
                ...
                my.levelConfig = {minLength: 99, maxLength: 99, branches : 15, maxRooms: 700, treasures: 1, openWeight: 1, closedWeight: 0, seed: undefined, width: 4, height: 25, duration: 499};
                ...
                my.levelConfig = {minLength: 99, maxLength: 99, branches : 9, maxRooms: undefined, treasures: 3, openWeight: .75, closedWeight: 0, seed: undefined, width: 9, height: 9, duration: 199};
